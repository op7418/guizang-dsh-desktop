...
| plugins | Azure 等非 CodePilot 内置目录不会进入服务商/模型界面 | 通过 | CodePilotProviderCatalog.ts |
...
| runtime | 输入区实际为 768px 宽 / 14px 圆角 | 通过 | {"selector":"[class*='_composerHero'] [class*='_card']","box":{"x":308,"y":468,"width":768,"height":159},"background":"oklch(1 0 0)","borderRadius":"14px","boxShadow":"rgba(0, 0, 0, 0.04) 0px 4px 14px 0px","padding":"8px 0px 0px","appRegion":"none"} |
...
| runtime | 通用设置卡片实际为 820px / 14px 且居中 | 通过 | {"selector":"[data-pilot-settings-card=\"general\"]","box":{"x":286,"y":72,"width":820,"height":523},"background":"oklch(1 0 0)","borderRadius":"14px","boxShadow":"rgba(0, 0, 0, 0.04) 0px 1px 2px 0px","padding":"0px 20px","appRegion":"none"} |
| runtime | 文件树浮层、工具栏与目录行均真实渲染 | 通过 | {"panel":{"selector":"aside[aria-label='Files']","box":{"x":818,"y":12,"width":322,"height":821},"background":"oklch(1 0 0)","borderRadius":"14px","boxShadow":"rgba(0, 0, 0, 0.05) 0px 2px 8px 0px, rgba(0, 0, 0, 0.06) 0px 12px 32px 0px","padding":"0px","appRegion":"none"},"toolbarButton":{"selector":"aside[aria-label='Files'] header button","box":{"x":1013,"y":33,"width":28,"height":28},"background":"rgba(0, 0, 0, 0)","borderRadius":"8px","boxShadow":"none","padding":"0px","appRegion":"no-drag"},"treeRow":{"selector":"aside[aria-label='Files'] [class*='_row']","box":{"x":827,"y":90,"width":304,"height":30},"background":"rgba(0, 0, 0, 0)","borderRadius":"8px","boxShadow":"none","padding":"0px","appRegion":"none"}} |
| runtime | 轨迹 toolbar、时间线与 ledger 卡片真实渲染 | 通过 | {"header":{"selector":"[data-pilot-conversation-header]","box":{"x":260,"y":0,"width":864,"height":52},"background":"rgba(0, 0, 0, 0)","borderRadius":"0px","boxShadow":"none","padding":"0px","appRegion":"none"},"toolbar":{"selector":"[role='toolbar'] > [class*='_inner']","box":{"x":260,"y":60,"width":872,"height":38},"background":"oklch(1 0 0)","borderRadius":"14px","boxShadow":"rgba(0, 0, 0, 0.04) 0px 1px 2px 0px","padding":"3px 4px","appRegion":"none"},"ledger":{"selector":"[class*='_ledger']","box":{"x":259,"y":168,"width":874,"height":665},"background":"oklch(1 0 0)","borderRadius":"14px","boxShadow":"rgba(0, 0, 0, 0.04) 0px 1px 2px 0px","padding":"0px","appRegion":"none"},"timeline":{"selector":"section[aria-label='Trajectory timeline']","box":{"x":259,"y":106,"width":874,"height":52},"background":"rgba(0, 0, 0, 0)","borderRadius":"14px","boxShadow":"rgba(0, 0, 0, 0.04) 0px 1px 2px 0px","padding":"0px","appRegion":"none"}} |
