...
| runtime | 输入区实际为 768px 宽 / 14px 圆角 | 通过 | {"selector":"[class*='_composerHero'] [class*='_card']","box":{"x":308,"y":468,"width":768,"height":159},"background":"oklch(1 0 0)","color":"oklch(0.147 0.004 49.25)","borderWidth":"1px","borderRadius":"14px","boxShadow":"rgba(0, 0, 0, 0.04) 0px 4px 14px 0px","position":"absolute","padding":"8px 0px 0px","appRegion":"none"} |
...
| runtime | 设置页实际铺满窗口且无网页弹窗圆角 | 通过 | {"selector":"[class*='_panel']:has(> [class*='_nav'] [class*='_navTitle'])","box":{"x":0,"y":0,"width":1152,"height":845},"background":"oklch(1 0 0)","color":"oklch(0.147 0.004 49.25)","borderWidth":"0px","borderRadius":"0px","boxShadow":"none","position":"relative","padding":"0px","appRegion":"none"} |
| runtime | 设置导航实际为 240px 并避让 40px 顶栏 | 通过 | {"selector":"[class*='_panel'] > [class*='_nav']:has([class*='_navTitle'])","box":{"x":0,"y":0,"width":240,"height":845},"background":"rgba(0, 0, 0, 0)","color":"oklch(0.147 0.004 49.25)","borderWidth":"0px","borderRadius":"0px","boxShadow":"none","position":"static","padding":"48px 8px 0px","appRegion":"none"} |
...
| runtime | Thinking 展开态为单一色块，标题与正文都不再拥有独立描边或底色 | 通过 | {"disclosure":{"selector":"[data-beautifului=\"thinking\"] [data-open=\"true\"]","box":{"x":318,"y":283,"width":756,"height":128},"background":"oklch(0.985 0.001 106.423)","color":"oklch(0.147 0.004 49.25)","borderWidth":"0px","borderRadius":"14px","boxShadow":"none","position":"static","padding":"4px","appRegion":"none"},"row":{"selector":"[data-beautifului=\"thinking\"] [data-open=\"true\"] [role=\"button\"]","box":{"x":322,"y":287,"width":748,"height":32},"background":"rgba(0, 0, 0, 0)","color":"oklch(0.147 0.004 49.25)","borderWidth":"0px","borderRadius":"8px","boxShadow":"none","position":"relative","padding":"0px 8px","appRegion":"none"},"body":{"selector":"[data-beautifului=\"thinking\"] [data-open=\"true\"] > div:last-child","box":{"x":322,"y":323,"width":748,"height":84},"background":"rgba(0, 0, 0, 0)","color":"oklch(0.553 0.013 58.071)","borderWidth":"0px","borderRadius":"10px","boxShadow":"none","position":"static","padding":"8px 12px 10px 28px","appRegion":"none"}} |
| runtime | 通用设置卡片实际为 820px / 14px 且居中 | 通过 | {"selector":"[data-pilot-settings-card=\"general\"]","box":{"x":286,"y":72,"width":820,"height":523},"background":"oklch(1 0 0)","color":"oklch(0.147 0.004 49.25)","borderWidth":"1px","borderRadius":"14px","boxShadow":"rgba(0, 0, 0, 0.04) 0px 1px 2px 0px","position":"static","padding":"0px 20px","appRegion":"none"} |
| runtime | 文件树作为贴右全高侧栏渲染并挤压对话区 | 通过 | {"viewport":{"width":1152,"height":900,"devicePixelRatio":2},"body":{"paddingTop":"0px","background":"rgba(0, 0, 0, 0)","fontFamily":"-apple-system, \"system-ui\", \"SF Pro Text\", \"Helvetica Neue\", \"PingFang SC\", sans-serif","dragStrip":"drag"},"tokens":{"--pilot-radius-base":"14px","--pilot-composer-radius":"14px","--pilot-nav-radius":"8px","--pilot-input-radius":"8px","--pilot-menu-radius":"14px","--pilot-sidebar-width":"240px","--pilot-background":"oklch(100% 0 0)","--pilot-foreground":"oklch(14.7% .004 49.25)","--pilot-border":"oklch(92.3% .003 48.717)","--pilot-shadow-diffuse":"0 12px 40px -8px #0000001a, 0 4px 12px -4px #0000000a","--pilot-text-primary":"oklch(14.7% .004 49.25)","--pilot-text-secondary":"color-mix(in oklch, oklch(14.7% .004 49.25) 72%, transparent)","--pilot-text-muted":"oklch(55.3% .013 58.071)","--pilot-text-caption":"color-mix(in oklch, oklch(14.7% .004 49.25) 46%, transparent)"},"elements":{"panel":{"selector":"aside[aria-label='Files']","box":{"x":832,"y":0,"width":320,"height":900},"background":"oklch(0.985 0.001 106.423 / 0.78)","color":"oklch(0.147 0.004 49.25)","borderWidth":"0px 0px 0px 1px","borderRadius":"0px","boxShadow":"none","position":"static","padding":"0px","appRegion":"none"},"conversation":{"selector":"[class*='_centerCol']","box":{"x":240,"y":0,"width":592,"height":900},"background":"rgba(0, 0, 0, 0)","color":"oklch(0.147 0.004 49.25)","borderWidth":"0px","borderRadius":"0px","boxShadow":"none","position":"static","padding":"0px","appRegion":"none"},"toolbarButton":{"selector":"aside[aria-label='Files'] header button","box":{"x":1026,"y":20,"width":28,"height":28},"background":"rgba(0, 0, 0, 0)","color":"oklch(0.147 0.004 49.25 / 0.72)","borderWidth":"0px","borderRadius":"8px","boxShadow":"none","position":"static","padding":"0px","appRegion":"no-drag"},"treeRow":{"selector":"aside[aria-label='Files'] [class*='_row']","box":{"x":841,"y":76,"width":303,"height":30},"background":"rgba(0, 0, 0, 0)","color":"oklch(0.147 0.004 49.25)","borderWidth":"0px","borderRadius":"8px","boxShadow":"none","position":"static","padding":"0px","appRegion":"none"}},"conversationWidthClosed":912} |
| runtime | 轨迹 toolbar、时间线与 ledger 使用无外框色块表面 | 通过 | {"header":{"selector":"[data-pilot-conversation-header]","box":{"x":260,"y":0,"width":864,"height":52},"background":"rgba(0, 0, 0, 0)","color":"oklch(0.147 0.004 49.25)","borderWidth":"0px","borderRadius":"0px","boxShadow":"none","position":"static","padding":"0px","appRegion":"none"},"toolbar":{"selector":"[role='toolbar'] > [class*='_inner']","box":{"x":260,"y":60,"width":872,"height":36},"background":"oklch(0.985 0.001 106.423)","color":"oklch(0.147 0.004 49.25)","borderWidth":"0px","borderRadius":"14px","boxShadow":"none","position":"static","padding":"3px 4px","appRegion":"none"},"ledger":{"selector":"[class*='_ledger']","box":{"x":260,"y":164,"width":872,"height":724},"background":"oklch(0.985 0.001 106.423)","color":"oklch(0.147 0.004 49.25)","borderWidth":"0px","borderRadius":"14px","boxShadow":"none","position":"relative","padding":"0px","appRegion":"none"},"timeline":{"selector":"section[aria-label='Trajectory timeline']","box":{"x":260,"y":104,"width":872,"height":50},"background":"oklch(0.985 0.001 106.423)","color":"oklch(0.147 0.004 49.25)","borderWidth":"0px","borderRadius":"14px","boxShadow":"none","position":"relative","padding":"0px","appRegion":"none"}} |
