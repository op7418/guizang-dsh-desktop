...
- `@deepseek-ai/dsh-client-ui-model-selection` — requires `sessionProjections` ([`packages/client/ui-model-selection/src/index.ts`](../packages/client/ui-model-selection/src/index.ts))
...
- `@deepseek-ai/dsh-ui-schedule-summary` — requires `connection` · `sessionPersistence` ([`packages/schedule/ui-schedule-summary/src/index.ts`](../packages/schedule/ui-schedule-summary/src/index.ts))
- `@deepseek-ai/dsh-ui-worktree` — requires `connection` · `workspaceRegistry` ([`packages/workspace/ui-worktree/src/index.ts`](../packages/workspace/ui-worktree/src/index.ts))
