...
- `@deepseek-ai/dsh-client-ui-codepilot-theme`（[`packages/client/ui-codepilot-theme/src/index.ts`](../packages/client/ui-codepilot-theme/src/index.ts)）
...
- `@deepseek-ai/dsh-client-ui-model-selection` — 需要 `sessionProjections`（[`packages/client/ui-model-selection/src/index.ts`](../packages/client/ui-model-selection/src/index.ts)）
...
- `@deepseek-ai/dsh-ui-schedule-summary` — 需要 `connection` · `sessionPersistence`（[`packages/schedule/ui-schedule-summary/src/index.ts`](../packages/schedule/ui-schedule-summary/src/index.ts)）
- `@deepseek-ai/dsh-ui-worktree` — 需要 `connection` · `workspaceRegistry`（[`packages/workspace/ui-worktree/src/index.ts`](../packages/workspace/ui-worktree/src/index.ts)）
