...
void test('accepts only explicit loopback HTTP server URLs', () => {
...
void test('extracts the settled URL from the DSH startup line', () => {
  assert.equal(
...
void test('line buffering preserves chunk boundaries and a final fragment', () => {
