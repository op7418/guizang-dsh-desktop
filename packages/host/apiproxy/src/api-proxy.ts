 ...
 * configuration boundary or the pickers silently fail to persist. The Agent
 * default-model plugin similarly owns the model used by future sessions; the
 * Models page writes that plugin section instead of duplicating the selection
 * in client or adapter state.
 */
