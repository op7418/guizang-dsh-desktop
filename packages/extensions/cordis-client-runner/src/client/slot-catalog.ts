...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    kind: 'list',
    scope: 'session',
    summary: 'The Context popover\'s extension seat for ambient conversation details.',
    doc: 'The Context popover\'s extension seat for ambient conversation details.\nSame InputZone owner share as the other\nregions. Anything the user must click belongs in the tool row instead\n(`conversation.input.left` / `.right`); anything needing its own line\nabove the card belongs in `conversation.input.dock`.',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'conversation.session.header\' (client-ui-conversation), so it exists while that entry is mounted',
    occupants: [
      'ui-worktree WorktreeHeaderToggle id \'worktree-toggle\'',
    ],
    replaceRisk: 'none',
  ...
  {
    key: 'conversation.trajectory.toolbar',
    kind: 'list',
    scope: 'session',
    summary: 'Session-scoped utilities rendered inside the Trajectory toolbar.',
    doc: 'Session-scoped utilities rendered inside the Trajectory toolbar.',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
    ...
    occupants: [
      'session-log-export SessionLogDownloadTrajectoryAction id \'session-log-download\'',
    ],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'conversation.trajectory.toolbar\', () => ctx.slots.register(\n      { name: \'conversation.trajectory.toolbar\', id: \'my-entry\', order: 100, label: \'My entry\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
    source: 'packages/client/ui-trajectory/src/client/index.ts:25',
  },
  {
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-settings-general SettingsDocumentAction id \'configuration-file\'',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'sidebar.settings\' (client-ui-settings-general), so it exists while that entry is mounted',
    occupants: [
      'client-ui-settings-models ProviderOnboardingDialog id \'provider-setup\'',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-settings-models ModelsSection id \'providers\'',
      'client-ui-settings-models ModelCatalogSection id \'models\'',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'root\' (client-ui-layout), so it exists while that entry is mounted',
    occupants: [
      'ui-worktree WorktreePanel id \'worktree-panel\'',
    ],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'shell.right-sidebar\', () => ctx.slots.register(\n      { name: \'shell.right-sidebar\', id: \'my-entry\', order: 100, label: \'My entry\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
  ...
  {
    key: 'sidebar.workspaces.session.detail',
    kind: 'list',
    scope: 'root',
    summary: 'Plugin-contributed rows inside one Session hover summary.',
    doc: 'Plugin-contributed rows inside one Session hover summary.',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
    ...
    declaredBy: 'an entry in \'sidebar.workspaces\' (client-ui-workspace), so it exists while that entry is mounted',
    occupants: [
      'client-ui-model-selection ModelSessionDetail id \'session-model\'',
      'ui-schedule-summary ScheduleSessionDetail id \'schedule-summary\'',
      'ui-worktree WorktreeSessionDetail id \'worktree-branch\'',
    ],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'sidebar.workspaces.session.detail\', () => ctx.slots.register(\n      { name: \'sidebar.workspaces.session.detail\', id: \'my-entry\', order: 100, label: \'My entry\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
