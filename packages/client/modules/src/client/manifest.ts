...
export interface ClientModuleLoader {
   ...
   * A host-provided revision also advances the row URL, guaranteeing that the
   * browser cannot reuse the previous classic-script response.
   * @param id - entry name to invalidate.
   * @param rev - optional fresh host content revision.
   */
