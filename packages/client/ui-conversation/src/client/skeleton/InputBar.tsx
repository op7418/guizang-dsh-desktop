...
export function InputBar({
  ...
  placeholder, accessory, overlay, leftItems, rightItems, footer, contextItems,
}: InputBarProps) {
    ...
    <div className={clsx(css.root, variant === 'hero' && css.hero)}>
      ...
      {toast !== null && (
        <Toast
          key={toast.seq}
          text={toast.text}
          icon={<CodePilotIcon name="warning" size={16} />}
      ...
      <div
        ...
        data-composer-card
        data-pilot-workspace-trigger={workspaceTrigger || undefined}
        data-beautifului="prompt-bar"
      ...
      >
            ...
            {interruptible && (
              <Tooltip label={t('input.stop')} side="top" delayMs={500}>
                <button
                  ...
                  onClick={stop}
                >
                  <CodePilotIcon name="stop" size={14} />
                </button>
              </Tooltip>
            )}
            <Tooltip label={primaryLabel} side="top" delayMs={500}>
              ...
              >
                {primaryStops ? (
                  ...
                  <CodePilotIcon name="send" size={16} strokeWidth={2.2} />
                )}
              </button>
            </Tooltip>
          </div>
        ...
        {footer !== null && footer !== undefined && (
          <div
            ...
            data-pilot-composer-context
            data-beautifului="context-strip"
          >
            {footer}
          </div>
        )}
