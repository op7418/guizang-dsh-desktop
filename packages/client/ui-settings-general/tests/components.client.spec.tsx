...
describe('AboutSection', () => {
  it('describes the product and exposes the upstream project', () => {
    const open = vi.spyOn(window, 'open').mockImplementation(() => null)
    render(<AboutSection {...kit} t={t} close={vi.fn()} />)
    expect(screen.getByRole('heading', { name: 'Pilot Harness' })).toBeTruthy()
