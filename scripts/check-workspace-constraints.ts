...
const packageFileExtras: Readonly<Record<string, readonly string[]>> = {
  ...
  '@deepseek-ai/dsh-client-ui-codepilot-theme': ['assets', 'cordis.patch.yml'],
  '@deepseek-ai/dsh-ui-worktree': ['cordis.patch.yml'],
  '@deepseek-ai/dsh-ui-schedule-summary': ['cordis.patch.yml'],
  '@deepseek-ai/dsh-session-log-export': ['cordis.patch.yml'],
...
function checkWorkspace({ dir, manifest }: WorkspaceManifest): string[] {
  ...
  if (isPublicLandlockPackage) {
    ...
    const expectedRepositoryUrl = manifest.name !== undefined && pilotHarnessReleaseMembers.has(manifest.name)
      ? pilotHarnessRepositoryUrl
